...
def rundom_generator(user_number):
    random_numb = random.randint(1, 100)
    if user_number == random_numb:
        print("Success!")
    else:
        print(f"Fail! Your number: {user_number}, Random number: {random_numb}")
...
def main():
    num = get_random_temp()
    print(f"The temperature right now is {num} degrees Celsius.")
