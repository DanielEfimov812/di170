...
// constructor number 2 will successfully extend the Dog class
...
// Because object2 and object3 reference the same object as object1, so when object1.number is changed to 4, they reflect the change.
// object4 is a separate object in memory, so its value remains 5.
...
const Cow = new Mammal("Lily", "cow", "brown and white");
